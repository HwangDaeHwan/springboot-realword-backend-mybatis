...
import com.realworld.backend.infrastructure.mybatis.readservice.CommentReadService;
...
public class CommentQueryService {
	...
	public List<CommentData> findByArticleId(String articleId, User user) {
		...
		if (comments.size() > 0 && user != null) {
			Set<String> followingAuthors = userRelationshipQueryService.followingAuthors(user.getId(), comments.stream()
	...
	public CursorPager<CommentData> findByArticleIdWithCursor(String articleId, User user,
